...
async fn start_server(local_addr: &str) -> Result<(), Box<dyn Error>> {
    ...
    server_addr_v = get_server_info("/Users/mostafalotfy/Documents/University/Fall 2023/Distributed Systems/Instagram_proj/Proj/Server1/src/DoSS.txt");
    ...
    // }
       ...
       if serv_struct_vec[0].size as usize == message_size{
            ...
            if chosen_server == server_port{
                //execute
                println!("I am the chosen server");
